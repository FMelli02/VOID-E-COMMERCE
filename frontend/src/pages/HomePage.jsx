      ...
      <section className="new-arrivals">
        ...
        <div className="product-grid">
          <div className="product-card">
            <img src="/img/Portada1.png" alt="Producto 1" />
          </div>
          <div className="product-card">
            <img src="/img/Portada2.png" alt="Producto 2" />
          </div>
          <div className="product-card">
            <img src="/img/Portada3.png" alt="Producto 3" />
          </div>
          <div className="product-card">
            <img src="/img/Portada4.png" alt="Producto 4" />
          </div>
          <div className="product-card">
            <img src="/img/Portada5.png" alt="Producto 5" />
          </div>
          <div className="product-card">
            <img src="/img/Portada6.png" alt="Producto 6" />
          </div>
        </div>
      </section>
    </main>
