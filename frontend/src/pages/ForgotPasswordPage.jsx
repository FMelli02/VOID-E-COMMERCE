...
const ForgotPasswordPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // En un proyecto real, acá llamarías a un endpoint tipo /api/auth/forgot-password
    // y el backend se encargaría de mandar el mail.
    console.log(`Solicitud de reseteo para: ${email}`);
    
    // Simulamos que la llamada tarda un poquito
